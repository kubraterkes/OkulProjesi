...
namespace OkulProjesi.DataSet1TableAdapters {
    ...
    public partial class Tbl_DerslerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::OkulProjesi.Properties.Settings.Default.OkulConnectionString;
        }
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Tbl_Ogrencıler.OGRID, Tbl_Ogrencıler.OGRAD, Tbl_Ogrencıler.OGRSOYAD, Tbl_O" +
                "grencıler.OGRCINSIYET, Tbl_Kulupler.KULUPAD\r\nFROM   Tbl_Ogrencıler INNER JOIN\r\n " +
                "            Tbl_Kulupler ON Tbl_Ogrencıler.OGRKULUP = Tbl_Kulupler.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT Tbl_Ogrencıler.OGRID, Tbl_Ogrencıler.OGRAD, Tbl_Ogrencıler.OGRSOYAD, Tbl_Ogrencıler.OGRCINSIYET, Tbl_Kulupler.KULUPAD
FROM   Tbl_Ogrencıler INNER JOIN
             Tbl_Kulupler ON Tbl_Ogrencıler.OGRKULUP = Tbl_Kulupler.KULUPID
WHERE (Tbl_Ogrencıler.OGRAD = @OGRAD)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO Tbl_Ogrencıler\r\n             (OGRAD, OGRSOYAD, OGRKULUP, OGRCINSIYET)" +
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE Tbl_Ogrencıler\r\nSET       OGRAD = @OGRAD, OGRSOYAD = @OGRSOYAD, OGRKULUP =" +
            ...
            this._commandCollection[4].CommandText = "DELETE FROM Tbl_Ogrencıler\r\nWHERE (OGRID = @OGRID)";
